-- Milestone-Based Streak System (Fixed Version)
-- This script drops and recreates functions to avoid type conflicts
...
DROP POLICY IF EXISTS "Everyone can view milestone badges" ON public.milestone_badges;
...
-- ============================================================================
-- CREATE NEW RECORD DAILY WEIGHT CHECKIN FUNCTION
-- ============================================================================
...
DROP TRIGGER IF EXISTS update_user_milestones_timestamp ON public.user_milestones;
